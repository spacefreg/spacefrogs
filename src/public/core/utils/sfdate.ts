...
export function setDate(date: sfDate, year: number, month: number, day: number): sfDate {
...
export function addOneDay(date: sfDate): sfDate {
...
export function dateEquals(date1: sfDate, date2: sfDate): boolean {
...
export function dateToString(date: sfDate): string {
    let day: string = '';
