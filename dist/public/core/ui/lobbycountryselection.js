...
export default class LobbyCountrySelection extends sfuiElement {
    constructor(origin, title) {
        ...
        this.countryElements = new Array();
    ...
    addCountry(origin, country) {
        ...
        const titlePos = new vec2(newestElement.getOrigin().x + textOffset.x, newestElement.getOrigin().y + textOffset.y);
